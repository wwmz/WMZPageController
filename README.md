# WMZPageController - 分页控制器,替换UIPageController方案,具备完整的生命周期（可传入子控制器/子视图）,多种指示器样式,多种标题样式,可悬浮,功能齐全,支持底部多级联动,支持嵌套多个菜单多页面（cocopod更新至1.4.1）
...
- 20211015 pod更新至1.4.1 支持侧滑/全屏/全部页面返回 新增两种动画JDAnimal NewAQY 修复KVO崩溃问题
- 20210814 pod更新至1.4.0 新增支持UIView传入/修复嵌套手势问题/新增下拉头视图缩放 
